            ...
            {selectedFile ? (
              <div className="flex flex-col items-center justify-center p-12 text-center relative z-10">
                ...
                <div className="flex gap-4">
                  ...
                  <button onClick={handleAnalyze} className="bg-gradient-to-r from-[#00C2B8] to-[#35F3FF] text-[#010a12] px-6 py-2 rounded-xl font-bold shadow-[0_0_20px_rgba(53,243,255,0.3)] hover:shadow-[0_0_30px_rgba(53,243,255,0.5)] transition-all flex items-center gap-2">
